...
import s7 from '../../assets/imageFiles/s7.png'
import s8 from '../../assets/imageFiles/s8.png'
import s9 from '../../assets/imageFiles/s9.png'
import s10 from '../../assets/imageFiles/s10.png'
            ...
            <Box className='implementbox' sx={{ height: { xs: '500px', sm: '400px', lg: '362px' }, flexDirection: { xs: 'column', sm: 'row' } }}>
                ...
                <Box className='textdesc' sx={{ display: 'flex', flexDirection: 'column', paddingY: { xs: '20px', lg: '38px' }, gap: { xs: '20px', lg: '40px' }, flex: 1 }}>
                    ...
                    <Box className='boxcontent' sx={{ padding: { xs: '10px', md: 0 } }}>
                        ...
                        >
                            ✨Continuous AI Implementation <br /> & Optimization
                        </Typography>
                    </Box>
                    <Box className='desc'
                        sx={{ fontSize: { xs: '14px', sm: '18px' }, fontFamily: 'Inter', fontWeight: '400', lineHeight: { xs: '24px', sm: '30px', md: '34px' } }}
                    >
                        Our ongoing support ensures your AI solutions evolve with your business, driving continuous improvement and sustainable growth
                    </Box>
                ...
                {steps.map((step, index) => (
                    <Box className='stepbox' key={index} sx={{ width: { xs: '100%', sm: '370px' ,xl:'384px' }, height: { xs: 'auto', sm: '405px' }, padding: { xs: '16px', sm: '24px 16px' }, gap: { xs: '16px', sm: '24px' } }}>
                        ...
                        <Box className='mapdetails' sx={{ height: { xs: 'auto', sm: '93px' } }}>
                            ...
                            <Typography className='title' sx={{ fontSize: { xs: '18px', sm: '20px' }, fontFamily: 'Poppins', fontWeight: '600', lineHeight: '33px'}}>{step.title}</Typography>
