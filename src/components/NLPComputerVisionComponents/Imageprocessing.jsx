    ...
    return (
        ...
        <Box className="styled-box" sx={{  height: { lg: '447px', xs: 'auto' }, gap: { xs: '16px', lg: '56px' } }}>
            <Box className="flex-content" sx={{  gap: { xs: '10px', lg: '24px' } }}>
                ...
                Ready to transform your visual data with <br /> Image Processing?
                </Typography>
                ...
                Contact Chisel today to learn more about our solutions and how they can benefit your business
                </Typography>
            </Box>
