...
const IntelligentCasestudy = () => {

    const caseData = {
        title: "Transforming in Manufacturing Industry",
        sections: [
            {
                label: "Challenge :",
                description: " A manufacturing company faced inefficiencies in its supply chain, leading to delays and increased costs"
            },
            {
                label: "Solution :",
                description: " Chisel implemented an AI-powered automation system that streamlined inventory management and optimized production schedules."
            },
            {
                label: "Outcome :",
                description: "The company achieved a 25% reduction in production costs and a 30% improvement in delivery times"
            }
        ],
        stats: [
            {
    ...
    return (
        ...
        <Typography className='case-studies-title' variant="h4" component="h2" align="center" gutterBottom sx={{ fontWeight: 'bold', fontSize: { xs: '28px', sm: '32px' }, fontFamily: 'Bebas Neue, Arial, sans-serif', letterSpacing: '1.6px' }}>
            Case Studies: AI Success Stories
        </Typography>
        <Typography className='impact-description' variant="body1" align="center" sx={{ fontFamily: 'inter', fontSize: { xs: '14px', md: '14px', lg: '16px' },lineHeight:'27px' }}>
            ...
            <Box className='inneritems' sx={{ gap: { xs: '10px' }, flexDirection: { xs: 'column', md: 'row' } }}>
                ...
                <Box className='first-inner-item' sx={{ width: { xs: '100%', sm: '100%', md: '716px' }, paddingLeft: { xs: 2, sm: 4 }, paddingRight: { xs: 2, sm: 4 } }}>
                    ...
                    <Box className='case-container'>
                        <Typography className='case-title' sx={{ fontSize: { xs: '20px', md: 22, lg: 24 }, fontWeight: 600, lineHeight: '36px',fontFamily:'poppins' }}>{caseData.title}</Typography>
                        ...
                        {caseData.sections.map((section, index) => (
                            <Box className='section-container ' key={index}>
                                ...
                                <Typography className="section-text">
                                    <Typography component="span" sx={{ color: 'rgba(255, 255, 255, 0.90)', fontSize: { xs: '14px', md:'16px' }, fontWeight: 500,fontFamily:'inter' }}>{section.label}</Typography>
                            ...
                            <React.Fragment key={index}>
                                <Box className='res-content'>
                                    <Box className='inline-flex-box'>
                                        <Typography sx={{ color: '#479A55', fontSize: { xs: '16px', md: '18px', lg: '20px' }, fontFamily: 'Inter', fontWeight: 600, lineHeight: '36px' }}>{item.percentage}</Typography>
...
export default IntelligentCasestudy
