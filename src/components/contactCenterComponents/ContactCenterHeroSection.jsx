...
const ContactCenterHeroSection = () => {
  return (
    ...
    >
      ...
      >
        <Box component={'img'} sx={{ width: 24, height: 24 }} src={cc1} alt="placeholder" />
      ...
      <Box>
       ...
       Upgrade Your Contact Center with AI <br /> Solutions
          <Box component={'img'} src={vector} sx={{ width: { xs: '15px', md: '18px', lg: '26px' }, position: 'absolute', right: { lg: '345px' } , bottom:{xs:'22px',lg:"30px"} }} />
        </Typography>
