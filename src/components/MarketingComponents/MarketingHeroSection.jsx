  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography sx={{ textAlign: 'center', color: '#7A64C1', fontSize: '14px', fontFamily: 'Inter', fontWeight: 400, lineHeight: '24px', wordWrap: 'break-word' }}>
          Marketing
        </Typography>
      </Box>
      ...
      <Box>
        ...
        >
          ...
          <Box component={'img'} src={m2} sx={{ width: { xs: '15px', md: '18px', lg: '26px' }, position: 'absolute', right: { lg: '383px' } , bottom:{xs:'22px',lg:"40px"} }} />
        </Typography>
