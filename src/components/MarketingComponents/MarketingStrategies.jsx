    ...
    return (
        ...
        <Box className="styled-box1" sx={{  height: { lg: '447px', xs: 'auto' }, gap: { xs: '16px', lg: '56px' } }}>
            <Box className="flex-content" sx={{  gap: { xs: '10px', lg: '24px' } }}>
                ...
                <Typography className="extraordinary-text" sx={{ width: { xs: '100%', lg: '1004px' }, height: { xs: '70px', lg: 'fit-content' }, fontFamily: 'Inter, sans-serif', fontWeight: 600, fontSize: { xs: '20px', sm: '25px', lg: '40px' }, lineHeight: { xs: '30px', lg: '50px' }}}>
                Ready to transform your marketing <br /> strategies?
                </Typography>
