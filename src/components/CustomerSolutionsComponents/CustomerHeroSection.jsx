  ...
  >
    ...
    >
      ...
      <Typography className='heading'
        ...
        component="h2"
        gutterBottom
        sx={{ fontWeight: 600,  fontSize: { xs: '1.8rem', md: '2rem', lg:'40px' }, fontFamily: 'inter' }}
      >
          AI-Powered Customer Experience <br /> Solutions
          <Box component={'img'} src={vector} sx={{ width: { xs: '15px', md: '18px', lg: '26px' }, position: 'absolute', right: { lg: '313px' },bottom:'26px' }} />
        </Typography>
