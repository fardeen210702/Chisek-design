  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography sx={{ textAlign: 'center', color: '#C73F2F', fontSize: '14px', fontFamily: 'Inter', fontWeight: 400, lineHeight: '24px', wordWrap: 'break-word' }}>
          Healthcare
        </Typography>
      </Box>
      ...
      <Box>
        ...
        Advance Healthcare with AI for Better <br /> Outcomes
          <Box component={'img'} src={h2} sx={{ width: { xs: '15px', md: '18px', lg: '26px' }, position: 'absolute', right: { lg: '333px' } , bottom:{xs:'22px',lg:"30px"} }} />
        </Typography>
