                ...
                <Box className='box-inner' sx={{
                    ...
                    <Box className='speech-to-text' sx={{flexDirection:{xs:'column',md:'row'}}}>
                        <Box className='left-speech-box' sx={{width:{xs:'100%',sm:'484px'}}}>
                            ...
                            <Box className='btnBox11'>
                                <Box sx={{display:'flex' , justifyContent:'space-around',gap:'14px'}}>
                                    <Button className='buttons' variant='contained' sx={{fontSize:'18px',lineHeight:'150%',fontWeight:500,fontFamily:'poppins',textTransform:'capitalize',borderRadius:'8px'}}>Start</Button>
                                    <Button className='buttons' variant='outlined' sx={{fontSize:'18px',lineHeight:'150%',fontWeight:500,fontFamily:'poppins',textTransform:'capitalize',color:'white',border:'1px solid #117DCC',borderRadius:'8px'}}>stop</Button>
                                </Box>

                                <Button startIcon={<RefreshIcon/>} className='reset' sx={{fontFamily:'poppins',fontWeight:400,textTransform:'capitalize',marginY:'24px',color:'#ADADAD',fontSize:'16px'}}>
                                 Reset
                                </Button>
                        ...
                        <Box className='typing-box' sx={{width:{xs:'100%',md:'716px'}}}>
                            ...
                            <Typography className='imgtypography10' sx={{fontFamily:'inter',fontSize:'16px',fontWeight:400}}>
