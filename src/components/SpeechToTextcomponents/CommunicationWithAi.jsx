    ...
    return (
        ...
        <Box className="styled-box" sx={{  height: { lg: '447px', xs: 'auto' }, gap: { xs: '16px', lg: '56px' } }}>
            <Box className="flex-content" sx={{  gap: { xs: '10px', lg: '24px' } }}>
                ...
                <Typography className="extraordinary-text" sx={{ width: { xs: '100%', lg: '1004px' }, height: { xs: '70px', lg: '140px' }, fontFamily: 'Inter, sans-serif', fontWeight: 600, fontSize: { xs: '20px', sm: '25px', lg: '40px' }, lineHeight: { xs: '30px', lg: '55px' }}}>
                Ready to enhance your communication <br /> with Speech to Text?
                </Typography>
                <Typography className="project-description"  sx={{ width: { xs: '100%', lg: '832px' }, height: { xs: '140px', lg: '60px' }, fontFamily: 'Inter, sans-serif', fontWeight: 400, fontSize: { xs: '14px', lg: '16 px' }, lineHeight: '30px' }}>
                Contact Chisel today to learn more about our Speech to Text solutions and how they can benefit your business.
                </Typography>
            </Box>
...
export default CommunicationWithAi;
