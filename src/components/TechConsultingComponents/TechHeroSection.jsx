...
const TechHeroSection = () => {
  ...
  >
    ...
    <Box>
      ...
      >
     Technology Consulting for AI Integration <br /> Services
        <Box component={'img'} src={vector} sx={{ width: { xs: '15px', md: '18px', lg: '26px' }, position: 'absolute', right: { lg: '339px' } , bottom:{xs:'18px',lg:"25px"} }} />
      </Typography>
      ...
      >
     Navigate AI complexities with Chisel’s expert consulting, ensuring your business is AI-ready with a clear, strategic <br /> implementation roadmap
      </Typography>
    </Box>
