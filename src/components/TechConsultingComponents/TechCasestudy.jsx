...
const AiCasestudy = () => {
    ...
    const caseData = {
        title: "Transforming  Retail Industry",
        sections: [
            {
                label: "Challenge :",
                description: "A leading retailer needed to assess its AI readiness and identify opportunities for AI-driven customer engagement."
            },
            {
                label: "Solution :",
                description: "Chisel conducted a thorough AI readiness assessment and developed a strategic roadmap for integrating AI into their customer service operations"
            },
            {
                label: "Outcome :",
                description: "The retailer successfully implemented AI-powered chatbots, resulting in a 40% increase in customer satisfaction and a 30% reduction in response times."
            }
        ],
        stats: [
            {
    ...
    return (
        <Container maxWidth={false}
            ...
            To illustrate the impact of AI-powered business transformation, we've compiled real-world examples of how our clients have <br /> successfully leveraged AI to overcome challenges and achieve remarkable results. 
            </Typography>
