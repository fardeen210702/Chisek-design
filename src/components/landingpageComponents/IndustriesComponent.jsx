                    ...
                    >
                        <Paper elevation={0} sx={{ width: '100%', height: '100%', padding: 2, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', marginBottom: 2, backgroundColor: '#101010', border: '0.2px solid #80808025', borderRadius: '10px', boxShadow: 'none' }}>
                            <div className='paperinner-div' >
                                ...
                                <Typography
                                    variant="h6"
                                    sx={{ width: 'calc(100% - 96px)', color: '#ffffff', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', fontFamily: 'poppins', fontWeight: 'bold', fontSize: { xs: '14px', md: '16px', lg: '20px', xl: '22px' } }}
                                >
                                    {item.title}
                                </Typography>
                            </div>
                            <Typography
                                variant="body1"
                                sx={{ fontSize: { xs: '14px', xl: '16px' }, color: '#ffffff85', overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', fontFamily: 'poppins' }}
                            >
                                {item.description}
                            </Typography>
                            <Button
