...
const ServicesComponent = () => {
  ...
  return (
    <Box sx={{ width: '100%',display: 'flex',flexDirection:'column',alignItems:'center', position: 'relative', zIndex: 1, pt: '5%' }}>
      {/* Background Image */}
      ...
      {/* Service Cards */}
      <Box sx={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '24px', width: '100%', maxWidth: '1200px' }}>
