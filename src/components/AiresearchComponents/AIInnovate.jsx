...
const AIInnovate = () => {
    return (
        <Container className="businesscontainer" sx={{ width: { xs: '100%', xl: '1200px' },  height: { lg: '447px', xs: 'auto' }, gap: { xs: '16px', lg: '56px' } }}>
            <Box className="styled-box21" sx={{  height: { lg: '447px', xs: 'auto' }, gap: { xs: '16px', lg: '56px' } }}>
                <Box className="flex-content" sx={{  gap: { xs: '10px', lg: '24px' } }}>

                    <Typography className="extraordinary-text" sx={{ width: { xs: '100%', lg: '1004px' }, height: { xs: '70px', lg: 'fit-content' }, fontFamily: 'Inter, sans-serif', fontWeight: 600, fontSize: { xs: '20px', sm: '25px', lg: '40px' }, lineHeight: { xs: '30px', lg: '70px' }}}>
                    ...
                    Let our experts help you explore emerging technologies, develop custom solutions, and secure a sustainable competitive edge in your industry.
                    </Typography>
                </Box>
